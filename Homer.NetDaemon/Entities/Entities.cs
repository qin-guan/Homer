...
//   At: 2025-08-09T12:21:11.6049505+08:00
//
...
public static class HumidifierEntityExtensionMethods
{
    ...
    ///<param name="humidity">Target humidity.</param>
    public static void SetHumidity(this HumidifierEntity target, double humidity)
    {
    ...
    ///<param name="humidity">Target humidity.</param>
    public static void SetHumidity(this IEnumerable<HumidifierEntity> target, double humidity)
    {
        target.CallService("set_humidity", new HumidifierSetHumidityParameters { Humidity = humidity });
    }

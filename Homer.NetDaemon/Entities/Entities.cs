...
//   At: 2026-06-14T20:42:59.9791949+08:00
//
...
public partial class ButtonEntities
{
    ...
    public ButtonEntity BathroomMotionIdentify => new(_haContext, "button.bathroom_motion_identify");
...
public partial class DeviceTrackerEntities
{
    ...
    ///<summary>Qin&apos;s Galaxy Watch8</summary>
    public DeviceTrackerEntity QinSGalaxyWatch8 => new(_haContext, "device_tracker.qin_s_galaxy_watch8");
    ///<summary>Qin&apos;s S26 Ultra</summary>
    public DeviceTrackerEntity QinSS26Ultra => new(_haContext, "device_tracker.qin_s_s26_ultra");
...
public partial class NotifyEntities
{
    ...
    ///<summary>Qin&apos;s Galaxy Watch8</summary>
    public NotifyEntity QinSGalaxyWatch8 => new(_haContext, "notify.qin_s_galaxy_watch8");
    ///<summary>Qin&apos;s S26 Ultra</summary>
    public NotifyEntity QinSS26Ultra => new(_haContext, "notify.qin_s_s26_ultra");
    ///<summary>Qin’s iPhone</summary>
...
public partial class SensorEntities
{
    ...
    ///<summary>Qin&apos;s Galaxy Watch8 Battery state</summary>
    public SensorEntity QinSGalaxyWatch8BatteryState => new(_haContext, "sensor.qin_s_galaxy_watch8_battery_state");
    ///<summary>Qin&apos;s Galaxy Watch8 Charger type</summary>
    public SensorEntity QinSGalaxyWatch8ChargerType => new(_haContext, "sensor.qin_s_galaxy_watch8_charger_type");
    ///<summary>Qin&apos;s S26 Ultra Battery state</summary>
    public SensorEntity QinSS26UltraBatteryState => new(_haContext, "sensor.qin_s_s26_ultra_battery_state");
    ///<summary>Qin&apos;s S26 Ultra Charger type</summary>
    public SensorEntity QinSS26UltraChargerType => new(_haContext, "sensor.qin_s_s26_ultra_charger_type");
    ...
    ///<summary>Bathroom Motion Illuminance</summary>
    public NumericSensorEntity BathroomMotionIlluminance => new(_haContext, "sensor.bathroom_motion_illuminance");
    ///<summary>Bathroom Motion Voltage</summary>
    public NumericSensorEntity BathroomMotionVoltage => new(_haContext, "sensor.bathroom_motion_voltage");
    ...
    ///<summary>Guan Xiuji&apos;s iPhone Pressure</summary>
    public NumericSensorEntity GuanXiujiSIphonePressure => new(_haContext, "sensor.guan_xiuji_s_iphone_pressure");
    ...
    ///<summary>Qin&apos;s Galaxy Watch8 Battery level</summary>
    public NumericSensorEntity QinSGalaxyWatch8BatteryLevel => new(_haContext, "sensor.qin_s_galaxy_watch8_battery_level");
    ///<summary>Qin&apos;s S26 Ultra Battery level</summary>
    public NumericSensorEntity QinSS26UltraBatteryLevel => new(_haContext, "sensor.qin_s_s26_ultra_battery_level");
    ...
    ///<summary>Qin’s iPhone Pressure</summary>
    public NumericSensorEntity QinsIphonePressure => new(_haContext, "sensor.qins_iphone_pressure");
...
public partial class UpdateEntities
{
    ...
    public UpdateEntity BathroomMotion => new(_haContext, "update.bathroom_motion");
...
public partial class NotifyServices
{
    ...
    ///<summary>Sends a notification message using the mobile_app_qin_s_galaxy_watch8 integration.</summary>
    public void MobileAppQinSGalaxyWatch8(NotifyMobileAppQinSGalaxyWatch8Parameters data)
    {
        _haContext.CallService("notify", "mobile_app_qin_s_galaxy_watch8", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppQinSGalaxyWatch8(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_qin_s_galaxy_watch8", null, new NotifyMobileAppQinSGalaxyWatch8Parameters { Message = message, Title = title, Target = target, Data = data });
    }

    ///<summary>Sends a notification message using the mobile_app_qin_s_s26_ultra integration.</summary>
    public void MobileAppQinSS26Ultra(NotifyMobileAppQinSS26UltraParameters data)
    {
        _haContext.CallService("notify", "mobile_app_qin_s_s26_ultra", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppQinSS26Ultra(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_qin_s_s26_ultra", null, new NotifyMobileAppQinSS26UltraParameters { Message = message, Title = title, Target = target, Data = data });
    }
...
public partial record NotifyMobileAppQinSGalaxyWatch8Parameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial record NotifyMobileAppQinSS26UltraParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }

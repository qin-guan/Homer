...
//   At: 2025-06-07T17:01:17.6622000+08:00
//
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Smart Plug 1 Cloud connection</summary>
    public BinarySensorEntity ZhiNengChaZuoCloudConnection => new(_haContext, "binary_sensor.zhi_neng_cha_zuo_cloud_connection");
    ///<summary>Smart Plug 1 Overheated</summary>
    public BinarySensorEntity ZhiNengChaZuoOverheated => new(_haContext, "binary_sensor.zhi_neng_cha_zuo_overheated");
    ///<summary>Smart Plug 1 Overloaded</summary>
    public BinarySensorEntity ZhiNengChaZuoOverloaded => new(_haContext, "binary_sensor.zhi_neng_cha_zuo_overloaded");
...
public partial class ButtonEntities
{
    ...
    ///<summary>Kitchen IKEA Plug Identify</summary>
    public ButtonEntity KitchenIkeaPlugIdentify => new(_haContext, "button.kitchen_ikea_plug_identify");
...
public partial class FanEntities
{
    ...
    ///<summary>Mi Smart Standing Fan 2 Lite</summary>
    public FanEntity MiSmartStandingFan2Lite => new(_haContext, "fan.mi_smart_standing_fan_2_lite");
}
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>dev_netdaemon_homer_net_daemon_apps_balcony_rainy_weather_close_blinds</summary>
    public InputBooleanEntity DevNetdaemonHomerNetDaemonAppsBalconyRainyWeatherCloseBlinds => new(_haContext, "input_boolean.dev_netdaemon_homer_net_daemon_apps_balcony_rainy_weather_close_blinds");
    ///<summary>dev_netdaemon_homer_net_daemon_apps_simply_go_concession_monitor</summary>
    public InputBooleanEntity DevNetdaemonHomerNetDaemonAppsSimplyGoConcessionMonitor => new(_haContext, "input_boolean.dev_netdaemon_homer_net_daemon_apps_simply_go_concession_monitor");
...
public partial class NumberEntities
{
    ...
    ///<summary>Mi Smart Standing Fan 2 Lite Delay off countdown</summary>
    public NumberEntity MiSmartStandingFan2LiteDelayOffCountdown => new(_haContext, "number.mi_smart_standing_fan_2_lite_delay_off_countdown");
    ...
    ///<summary>Smart Plug 1 Power protection</summary>
    public NumberEntity ZhiNengChaZuoPowerProtection => new(_haContext, "number.zhi_neng_cha_zuo_power_protection");
    ///<summary>Smart Plug 1 Turn off in</summary>
    public NumberEntity ZhiNengChaZuoTurnOffIn => new(_haContext, "number.zhi_neng_cha_zuo_turn_off_in");
}
...
public partial class SelectEntities
{
    ...
    ///<summary>Kitchen IKEA Plug Power-on behavior</summary>
    public SelectEntity KitchenIkeaPlugPowerOnBehavior => new(_haContext, "select.kitchen_ikea_plug_power_on_behavior");
...
public partial class SensorEntities
{
    ...
    ///<summary>Smart Plug 1 Auto-off at</summary>
    public SensorEntity ZhiNengChaZuoAutoOffAt => new(_haContext, "sensor.zhi_neng_cha_zuo_auto_off_at");
    ///<summary>Smart Plug 1 Signal level</summary>
    public SensorEntity ZhiNengChaZuoSignalLevel => new(_haContext, "sensor.zhi_neng_cha_zuo_signal_level");
    ...
    ///<summary>Kitchen IKEA Plug Current</summary>
    public NumericSensorEntity KitchenIkeaPlugCurrent => new(_haContext, "sensor.kitchen_ikea_plug_current");
    ///<summary>Kitchen IKEA Plug Energy</summary>
    public NumericSensorEntity KitchenIkeaPlugEnergy => new(_haContext, "sensor.kitchen_ikea_plug_energy");
    ///<summary>Kitchen IKEA Plug Power</summary>
    public NumericSensorEntity KitchenIkeaPlugPower => new(_haContext, "sensor.kitchen_ikea_plug_power");
    ///<summary>Kitchen IKEA Plug Voltage</summary>
    public NumericSensorEntity KitchenIkeaPlugVoltage => new(_haContext, "sensor.kitchen_ikea_plug_voltage");
    ...
    ///<summary>Smart Plug 1 Current</summary>
    public NumericSensorEntity ZhiNengChaZuoCurrent => new(_haContext, "sensor.zhi_neng_cha_zuo_current");
    ///<summary>Smart Plug 1 Current consumption</summary>
    public NumericSensorEntity ZhiNengChaZuoCurrentConsumption => new(_haContext, "sensor.zhi_neng_cha_zuo_current_consumption");
    ///<summary>Smart Plug 1 This month&apos;s consumption</summary>
    public NumericSensorEntity ZhiNengChaZuoThisMonthSConsumption => new(_haContext, "sensor.zhi_neng_cha_zuo_this_month_s_consumption");
    ///<summary>Smart Plug 1 Today&apos;s consumption</summary>
    public NumericSensorEntity ZhiNengChaZuoTodaySConsumption => new(_haContext, "sensor.zhi_neng_cha_zuo_today_s_consumption");
    ///<summary>Smart Plug 1 Voltage</summary>
    public NumericSensorEntity ZhiNengChaZuoVoltage => new(_haContext, "sensor.zhi_neng_cha_zuo_voltage");
}
...
public partial class SwitchEntities
{
    ...
    ///<summary>Kitchen IKEA Plug</summary>
    public SwitchEntity KitchenIkeaPlug => new(_haContext, "switch.kitchen_ikea_plug");
    ...
    ///<summary>Mi Smart Standing Fan 2 Lite Buzzer</summary>
    public SwitchEntity MiSmartStandingFan2LiteBuzzer => new(_haContext, "switch.mi_smart_standing_fan_2_lite_buzzer");
    ///<summary>Mi Smart Standing Fan 2 Lite Child lock</summary>
    public SwitchEntity MiSmartStandingFan2LiteChildLock => new(_haContext, "switch.mi_smart_standing_fan_2_lite_child_lock");
    ///<summary>Mi Smart Standing Fan 2 Lite LED</summary>
    public SwitchEntity MiSmartStandingFan2LiteLed => new(_haContext, "switch.mi_smart_standing_fan_2_lite_led");
    ...
    public SwitchEntity ZhiNengChaZuo => new(_haContext, "switch.zhi_neng_cha_zuo");
    ///<summary>Smart Plug 1 Auto-off enabled</summary>
    public SwitchEntity ZhiNengChaZuoAutoOffEnabled => new(_haContext, "switch.zhi_neng_cha_zuo_auto_off_enabled");
    ///<summary>Smart Plug 1 Auto-update enabled</summary>
    public SwitchEntity ZhiNengChaZuoAutoUpdateEnabled => new(_haContext, "switch.zhi_neng_cha_zuo_auto_update_enabled");
    ///<summary>Smart Plug 1 LED</summary>
    public SwitchEntity ZhiNengChaZuoLed => new(_haContext, "switch.zhi_neng_cha_zuo_led");
...
public partial class UpdateEntities
{
    ...
    ///<summary>Kitchen IKEA Plug</summary>
    public UpdateEntity KitchenIkeaPlug => new(_haContext, "update.kitchen_ikea_plug");
    ///<summary>Living Room IKEA Plug</summary>
...
public partial class XiaomiMiioServices
{
    ...
    ///<summary>Resets the filter lifetime and usage.</summary>
    public void FanResetFilter(XiaomiMiioFanResetFilterParameters data)
    {
        _haContext.CallService("xiaomi_miio", "fan_reset_filter", null, data);
    }

    ///<summary>Resets the filter lifetime and usage.</summary>
    ///<param name="entityId">Name of the Xiaomi Miio entity.</param>
    public void FanResetFilter(string? entityId = null)
    {
        _haContext.CallService("xiaomi_miio", "fan_reset_filter", null, new XiaomiMiioFanResetFilterParameters { EntityId = entityId });
    }

    ///<summary>Manipulates a storage register which advertises extra features. The Mi Home app evaluates the value. A feature called &quot;turbo mode&quot; is unlocked in the app on value 1.</summary>
    public void FanSetExtraFeatures(XiaomiMiioFanSetExtraFeaturesParameters data)
    {
        _haContext.CallService("xiaomi_miio", "fan_set_extra_features", null, data);
    }

    ///<summary>Manipulates a storage register which advertises extra features. The Mi Home app evaluates the value. A feature called &quot;turbo mode&quot; is unlocked in the app on value 1.</summary>
    ///<param name="entityId">Name of the Xiaomi Miio entity.</param>
    ///<param name="features">Integer, known values are 0 (default) and 1 (turbo mode).</param>
    public void FanSetExtraFeatures(double features, string? entityId = null)
    {
        _haContext.CallService("xiaomi_miio", "fan_set_extra_features", null, new XiaomiMiioFanSetExtraFeaturesParameters { EntityId = entityId, Features = features });
    }
}

public partial record XiaomiMiioFanResetFilterParameters
{
    ///<summary>Name of the Xiaomi Miio entity.</summary>
    [JsonPropertyName("entity_id")]
    public string? EntityId { get; init; }
}

public partial record XiaomiMiioFanSetExtraFeaturesParameters
{
    ///<summary>Name of the Xiaomi Miio entity.</summary>
    [JsonPropertyName("entity_id")]
    public string? EntityId { get; init; }

    ///<summary>Integer, known values are 0 (default) and 1 (turbo mode).</summary>
